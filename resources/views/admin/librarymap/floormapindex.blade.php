...
<div class="container-fluid mt-2">
    <div class="row">
        <div class="col-12 col-sm-4 col-md-3">
            ...
            @foreach($floors as $floor)
                <a href="{{route("admin.librarymap.floormap",$floor->id)}}" class="row floor"  @if($floor->id==$id) style="background-color: rgba(0,105,255,0.89)" @endif>
    ...
    <div class="designblockrow">
        <div class="designblock mt-3" style="width: {{$deswidth}}px;height: {{$desheight}}px">
            ...
            <a href="#" class="draggable" style="width:{{$floormap->width}}px;height: {{$floormap->height}}px;top:{{$floormap->top}}px;left:{{$floormap->left}}px;">
