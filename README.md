...
其中 `.env` 與正式資料庫 Dump 不應公開提交至 Repository。

---

# Repository

GitHub：<https://github.com/LiaoZike/library_Web>

---

## 專案定位

此專案的核心不是單純的圖書 CRUD，而是將：

**圖書館空間配置、館藏位置、影像辨識、盤點批次與人工確認流程整合到同一套 Web 管理系統中。**

其目的在於讓自動化影像盤點結果可以被快速瀏覽、定位與修正，並保留每次盤點的歷史紀錄供後續查詢。
